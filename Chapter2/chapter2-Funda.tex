...
\begin{figure}[H]
	\centering
	\includegraphics[width=0.9\textwidth]{Figures/waveform_vs_spectrogram.png}
	\caption{Comparison of Speech Waveform and Spectrogram Representations}
	\label{fig:waveform_spectrogram}
\end{figure}

\begin{figure}[H]
	\centering
	\includegraphics[width=0.85\textwidth]{Figures/mel_spectrogram_example.png}
	\caption{Mel Spectrogram Example: Frequency-Time Representation of Speech}
